...
namespace Exercises.Tests
{
     ...
     */
        ...
        [TestMethod]
        public void MatchingPlatesTest()
        {
            char[] meals = new char[] { 'b', 's', 's', 'b' };
            char[] stack = new char[] { 'b', 's', 's', 'b' };

            char[] test1 = new char[] { 'b', 's', 's', 'b', 's' };
            char[] test2 = new char[] { 'b', 's', 's', 'b' };

            char[] test3 = new char[] { 'b', 's', 's', 'b', 's' };
            char[] test4 = new char[] { 'b', 's', 's', 'b', 's', 'b','s' };

            Assert.AreEqual(true, exercises.matchingPlates(meals, stack));
            Assert.AreEqual(false, exercises.matchingPlates(test1, test2));
            Assert.AreEqual(true, exercises.matchingPlates(test3, test4));
        ...
        {
            Assert.AreEqual(0, exercises.DescendingOrder(0));
            Assert.AreEqual(54221, exercises.DescendingOrder(21254));
        }
